  ...
  <div class="space-y-4">
    ...
    <div class="faq-item border rounded-lg">
        <button class="faq-question w-full flex justify-between items-center p-4 font-semibold">
            What is MyBox used for?
            <i class="fas fa-chevron-down"></i>
        </button>
        <div class="faq-answer hidden px-4 pb-4 text-gray-600">
            MyBox is a modern file manager that allows you to store, organize, and access your files securely anytime.
        </div>
    </div>
    ...
    <div class="faq-item border rounded-lg">
        <button class="faq-question w-full flex justify-between items-center p-4 font-semibold">
            Is my data safe in MyBox?
            <i class="fas fa-chevron-down"></i>
        </button>
        <div class="faq-answer hidden px-4 pb-4 text-gray-600">
            Yes, all files are stored securely with authentication and protection mechanisms.
        </div>
    </div>
    ...
    <div class="faq-item border rounded-lg">
        ...
        <div class="faq-answer hidden px-4 pb-4 text-gray-600">
            You can upload images, PDFs, documents, videos and many other supported file formats.
        </div>
    </div>
    ...
    <div class="faq-item border rounded-lg">
        ...
        <div class="faq-answer hidden px-4 pb-4 text-gray-600">
            Yes, file size limits depend on system configuration and server settings.
        </div>
    </div>
    ...
    <div class="faq-item border rounded-lg">
        <button class="faq-question w-full flex justify-between items-center p-4 font-semibold">
            Can I access MyBox on mobile?
            <i class="fas fa-chevron-down"></i>
        </button>
        <div class="faq-answer hidden px-4 pb-4 text-gray-600">
            Yes, MyBox is fully responsive and works on mobile, tablet, and desktop devices.
        </div>
    </div>
    ...
    <div class="faq-item border rounded-lg">
        <button class="faq-question w-full flex justify-between items-center p-4 font-semibold">
            Can I delete or manage my files?
            <i class="fas fa-chevron-down"></i>
        </button>
        <div class="faq-answer hidden px-4 pb-4 text-gray-600">
            Yes, you have full control to upload, delete, rename, and organize your files anytime.
        </div>
    </div>
